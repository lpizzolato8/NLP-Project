public class Part2Tester {
    ...
    public static void main(String[] args) {
         ...
         * String line =
         * "\"4\",\"3\",\"Mon May 11 03:17:40 UTC 2009\",\"kindle2\",\"tpryan\",\"@stellargirl I "
         * +
         ...
         * expected.getAuthor().equals(result.getAuthor()));
         * System.out.println("test3: " +
         * expected.getTimestamp().equals(result.getTimestamp()));
         * 
         * // Test case for EBook dataset
         * Sentence sent = new Sentence("Example sentence from a book", "Ada Lovelace",
         * "Chapter 1");
         * sent.addToEnd(" continues, and then ends, here.");
         * System.out.println("test1: " + sent.getText().
         * equals("Example sentence from a book continues and then ends here"));
         */

        // Test cases for Twitter COVID19 dataset.

        // NOTE: Modified line input according to how it is formatted on our Covid-19
        // CSV file
        // (added triple quotations around each cell, did not change raw data)
